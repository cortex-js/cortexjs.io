...
```ts
readonly scope: {
  parentScope: { parentScope?: ...; ids?: RuntimeIdentifierDefinitions; assumptions: ExpressionMapInterface<boolean>; };
  ids: RuntimeIdentifierDefinitions;
...
<a id="boxedexpression_shape-1" name="boxedexpression_shape-1"></a>
...
<a id="boxedexpression_rank-1" name="boxedexpression_rank-1"></a>
...
<a id="numericvalue_constructors-1" name="numericvalue_constructors-1"></a>
...
<a id="tensorfieldnumber_constructors-2" name="tensorfieldnumber_constructors-2"></a>
...
<a id="tensorfieldexpression_constructors-3" name="tensorfieldexpression_constructors-3"></a>
...
<a id="tensorfieldcomplex_constructors-4" name="tensorfieldcomplex_constructors-4"></a>
...
<a id="tensordatadt_shape-2" name="tensordatadt_shape-2"></a>
...
<a id="abstracttensordt_constructors-5" name="abstracttensordt_constructors-5"></a>
...
<a id="boxedtype_constructors" name="boxedtype_constructors"></a>
...
<a id="computeengine_constructors" name="computeengine_constructors"></a>
...
<a id="computeengine_true" name="computeengine_true"></a>
...
<a id="computeengine_false" name="computeengine_false"></a>
...
<a id="computeengine_pi" name="computeengine_pi"></a>
...
<a id="computeengine_e" name="computeengine_e"></a>
...
<a id="computeengine_nothing" name="computeengine_nothing"></a>
...
<a id="computeengine_zero" name="computeengine_zero"></a>
...
<a id="computeengine_one" name="computeengine_one"></a>
...
<a id="computeengine_half" name="computeengine_half"></a>
...
<a id="computeengine_negativeone" name="computeengine_negativeone"></a>
...
<a id="computeengine_two" name="computeengine_two"></a>
...
<a id="computeengine_i" name="computeengine_i"></a>
...
<a id="computeengine_nan" name="computeengine_nan"></a>
...
<a id="computeengine_positiveinfinity" name="computeengine_positiveinfinity"></a>
...
<a id="computeengine_negativeinfinity" name="computeengine_negativeinfinity"></a>
...
<a id="computeengine_complexinfinity" name="computeengine_complexinfinity"></a>
...
<a id="computeengine_decimalseparator" name="computeengine_decimalseparator"></a>
...
<a id="computeengine_context" name="computeengine_context"></a>
...
<a id="computeengine_strict" name="computeengine_strict"></a>
...
<a id="computeengine__deadline" name="computeengine__deadline"></a>

<MemberCard>

#### ComputeEngine.\_deadline
...
<a id="computeengine_latexdictionary" name="computeengine_latexdictionary"></a>
...
```ts
get latexDictionary(): readonly OnlyFirst<
  | ExpressionEntry
  | MatchfixEntry
  | InfixEntry
  | PostfixEntry
  ...
  | EnvironmentEntry
  | DefaultEntry>[]
set latexDictionary(dic: readonly OnlyFirst<
  | ExpressionEntry
  | MatchfixEntry
  | InfixEntry
  | PostfixEntry
...
<a id="computeengine_precision" name="computeengine_precision"></a>
...
<a id="computeengine_angularunit" name="computeengine_angularunit"></a>
...
set angularUnit(u: AngularUnit): void
```
...
<a id="computeengine_timelimit" name="computeengine_timelimit"></a>
...
<a id="computeengine__timeremaining" name="computeengine__timeremaining"></a>

<MemberCard>

#### ComputeEngine.\_timeRemaining

Time remaining before _deadline

</MemberCard>

<a id="computeengine_iterationlimit" name="computeengine_iterationlimit"></a>
...
set iterationLimit(t: number): void
```
...
<a id="computeengine_recursionlimit" name="computeengine_recursionlimit"></a>
...
set recursionLimit(t: number): void
```
...
<a id="computeengine_tolerance" name="computeengine_tolerance"></a>
...
set tolerance(val: number | "auto"): void
```
...
<a id="computeengine_costfunction" name="computeengine_costfunction"></a>
...
set costFunction(fn: (expr) => number): void
```
...
<a id="computeengine_assumptions" name="computeengine_assumptions"></a>
...
<a id="computeengine_getstandardlibrary" name="computeengine_getstandardlibrary"></a>
...
```ts
static getStandardLibrary(categories): readonly Readonly<{}>[]
```
...
<a id="computeengine_getlatexdictionary" name="computeengine_getlatexdictionary"></a>
...
```ts
static getLatexDictionary(domain): readonly Readonly<OnlyFirst<
  | ExpressionEntry
  | MatchfixEntry
  | InfixEntry
  | PostfixEntry
...
<a id="computeengine_tostring" name="computeengine_tostring"></a>
...
<a id="computeengine_chop" name="computeengine_chop"></a>
...
<a id="computeengine_bignum" name="computeengine_bignum"></a>
...
<a id="computeengine_complex" name="computeengine_complex"></a>
...
<a id="computeengine_lookupsymbol" name="computeengine_lookupsymbol"></a>
...
```ts
lookupSymbol(symbol, wikidata?, scope?): BoxedSymbolDefinition
```
...
\{ parentScope?: ...; ids?: RuntimeIdentifierDefinitions; assumptions: ExpressionMapInterface\<boolean\>; \}

###### ids

[`RuntimeIdentifierDefinitions`](#runtimeidentifierdefinitions)
...
<a id="computeengine_lookupfunction" name="computeengine_lookupfunction"></a>
...
```ts
lookupFunction(name, scope?): BoxedFunctionDefinition
```
...
<a id="computeengine__definesymbol" name="computeengine__definesymbol"></a>
...
[`SymbolDefinition`](#symboldefinition-1)

</MemberCard>

<a id="computeengine__definefunction" name="computeengine__definefunction"></a>
...
<a id="computeengine_pushscope" name="computeengine_pushscope"></a>
...
```ts
pushScope(scope?): IComputeEngine
```
...
`Partial`\<[`Scope`](#scope-2)\>

</MemberCard>

<a id="computeengine_popscope" name="computeengine_popscope"></a>
...
<a id="computeengine_swapscope" name="computeengine_swapscope"></a>
...
<a id="computeengine_declare" name="computeengine_declare"></a>
...
`string` | `OnlyFirst`\<[`Type`](#type-2), (("string" \| "number" \| "boolean" \| "symbol" \| "function" \| "map" \| "set" \| "error" \| "real" \| "value" \| "unknown" \| "integer" \| "never" \| "expression" \| "any" \| "finite\_number" \| ... 22 more ... \| TypeReference) & BaseDefinition & Partial\<...\> & \{ ...; \}) & BaseDefinition & Partial\<...\> & \{ ...; \}\> | `OnlyFirst`\<[`SymbolDefinition`](#symboldefinition-1), (("string" \| "number" \| "boolean" \| "symbol" \| "function" \| "map" \| "set" \| "error" \| "real" \| "value" \| "unknown" \| "integer" \| "never" \| "expression" \| "any" \| "finite\_number" \| ... 22 more ... \| TypeReference) & BaseDefinition & Partial\<...\> & \{ ...; \}) & BaseDefinition & Partial\<...\> & \{ ...; \}\> | `OnlyFirst`\<[`FunctionDefinition`](#functiondefinition-1), (("string" \| "number" \| "boolean" \| "symbol" \| "function" \| "map" \| "set" \| "error" \| "real" \| "value" \| "unknown" \| "integer" \| "never" \| "expression" \| "any" \| "finite\_number" \| ... 22 more ... \| TypeReference) & BaseDefinition & Partial\<...\> & \{ ...; \}) & BaseDefinition & Partial\<...\> & \{ ...; \}\>

##### declare(identifiers)

```ts
declare(identifiers): IComputeEngine
```
...
<a id="computeengine_assign" name="computeengine_assign"></a>
...
<a id="computeengine_box" name="computeengine_box"></a>
...
<a id="computeengine_function" name="computeengine_function"></a>
...
readonly [`Expression`](#expression)[] | readonly [`BoxedExpression`](#boxedexpression)[]
...
<a id="computeengine_error" name="computeengine_error"></a>
...
<a id="computeengine_typeerror" name="computeengine_typeerror"></a>
...
```ts
typeError(expected, actual, where?): BoxedExpression
```
...
[`Type`](#type-2) | [`BoxedType`](#boxedtype)
...
<a id="computeengine_hold" name="computeengine_hold"></a>
...
<a id="computeengine_tuple" name="computeengine_tuple"></a>
...
<a id="computeengine_type" name="computeengine_type"></a>
...
<a id="computeengine_string" name="computeengine_string"></a>
...
<a id="computeengine_symbol" name="computeengine_symbol"></a>
...
<a id="computeengine_number" name="computeengine_number"></a>
...
<a id="computeengine_rules" name="computeengine_rules"></a>
...
[`Rule`](#rule) | [`BoxedRuleSet`](#boxedruleset) | readonly Rule \| BoxedRule[]
...
<a id="computeengine_getruleset" name="computeengine_getruleset"></a>
...
<a id="computeengine_parse" name="computeengine_parse"></a>
...
`Partial`\<`ParseLatexOptions`\> & \{
  `canonical`: [`CanonicalOptions`](#canonicaloptions);
 \}
...
<a id="computeengine_ask" name="computeengine_ask"></a>
...
<a id="computeengine_verify" name="computeengine_verify"></a>
...
<a id="computeengine_assume" name="computeengine_assume"></a>
...
<a id="computeengine_forget" name="computeengine_forget"></a>
...
<a id="highlightcodespan" name="highlightcodespan"></a>
...
```ts
function highlightCodeSpan(code, grammar?): StyledSpan[]
```
...
<a id="highlightcodeblock" name="highlightcodeblock"></a>
