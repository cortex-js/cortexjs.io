...
description: "A Cortex program is an expression that gets transformed into an IR (Intermediate Representation) expressed in MathJSON, compiled and evaluated by the Co…"
hide_title: true
date: Last Modified
---
# Inside Cortex
